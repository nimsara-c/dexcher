...
namespace Dexcher
{
    ...
    public:
        ...
        void run()
        {
            // Configure a separate thread for tray icon
    ...
    private:
        ...
        void runTrayIcon()
        {
            ...
            long activeTotalDesktopCountState = (this->m_config.totalDesktopCount < 4) ? this->m_config.totalDesktopCount : 4; // Get the current value
        ...
        void runGUI()
        {
            Dexcher::GUI gui("Dexcher", Vector2(560, 360));
