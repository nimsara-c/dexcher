...
namespace Dexcher
{
    ...
    public:
        GUI(std::string _title, Vector2 _windowSize) : m_windowTitle(_title)
        {
            ...
            std::strcpy(this->m_activeAppListBuffer, Dexcher::strVecToChar(this->m_config.activeAppList));
        }
    ...
    private:
        ...
        int init()
        {
            ...
            this->m_tabFont = this->m_io->Fonts->AddFontFromFileTTF(m_fontPath.c_str(), 20.0f);
        ...
        int render(bool &_isGUIRunning, bool &_isConfigFileChanged)
        {
            ...
            while (!glfwWindowShouldClose(this->m_window))
            {
                ...
                // Main Window
                {
                    ...
                    static ImGuiWindowFlags flags = ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize;
